...
class TestTLSArecgen(unittest.TestCase):
    def testTLSAFromFile301(self):
        tlsa = tlsarecgen.tlsaFromFile({'filename': 'test/fullchain.pem', 'usage': 3, 'selector': 0, 'matchingtype': 1})
    ...
    def testTLSAFromFile311(self):
        tlsa = tlsarecgen.tlsaFromFile({'filename': 'test/fullchain.pem', 'usage': 3, 'selector': 1, 'matchingtype': 1})
    ...
    def testTLSAFromFile302(self):
        tlsa = tlsarecgen.tlsaFromFile({'filename': 'test/fullchain.pem', 'usage': 3, 'selector': 0, 'matchingtype': 2})
    ...
    def testTLSAFromFile312(self):
        tlsa = tlsarecgen.tlsaFromFile({'filename': 'test/fullchain.pem', 'usage': 3, 'selector': 1, 'matchingtype': 2})
    ...
    def testTLSAFromFile201(self):
        tlsa = tlsarecgen.tlsaFromFile({'filename': 'test/fullchain.pem', 'usage': 2, 'selector': 0, 'matchingtype': 1})
    ...
    def testTLSAFromFile211(self):
        tlsa = tlsarecgen.tlsaFromFile({'filename': 'test/fullchain.pem', 'usage': 2, 'selector': 1, 'matchingtype': 1})
    ...
    def testTLSAFromFile202(self):
        tlsa = tlsarecgen.tlsaFromFile({'filename': 'test/fullchain.pem', 'usage': 2, 'selector': 0, 'matchingtype': 2})
    ...
    def testTLSAFromFile212(self):
        tlsa = tlsarecgen.tlsaFromFile({'filename': 'test/fullchain.pem', 'usage': 2, 'selector': 1, 'matchingtype': 2})
